...
@push('js')
    <script>
        ...
        table.DataTable({
            ...
            columns: [{
                ...
                },
                {
                    ...
                    searchable: false,
                    sortable: false,
                    visible: {{ (int) auth()->user()->can('cources-status') }}
                },
                {
                    data: 'actions_column',
                    searchable: false,
                    ...
                    visible: {{ (int) (auth()->user()->can('cources-store') || auth()->user()->can('cources-delete')) }}
                },
            ]
        });
        ...
        function openModal(id = '') {
            $.get('{{ route('admin.cources.form') }}?id=' + id, function(data) {
