...
@push('js')
    <script>
        ...
        table.DataTable({
            ...
            columns: [{
                ...
                },
                {
                    ...
                    searchable: false,
                    sortable: false,
                    visible: {{ (int) auth()->user()->can('musics-status') }}
                },
                {
                    data: 'actions_column',
                    searchable: false,
                    ...
                    visible: {{ (int) (auth()->user()->can('musics-store') || auth()->user()->can('musics-delete')) }}
                },
            ]
        });
        ...
        function openModal(id = '') {
            $.get('{{ route('admin.musics.form') }}?id=' + id, function(data) {
