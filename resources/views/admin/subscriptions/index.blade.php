        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            <div class="kt-portlet__head-label">
                ...
                <h3 class="kt-portlet__head-title">
                    @lang('navigation.subscriptions')
                </h3>
            </div>
            {{-- <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">&nbsp;
                        @can('subscriptions-store')
...
@push('js')
    <script>
        ...
        table.DataTable({
            ...
            columns: [{
                ...
                },
                {
                    ...
                    searchable: false,
                    sortable: false,
                    visible: {{ (int) auth()->user()->can('subscriptions-status') }}
                },
                {
                    data: 'actions_column',
                    searchable: false,
                    ...
                    visible: {{ (int) (auth()->user()->can('subscriptions-store') || auth()->user()->can('subscriptions-delete')) }}
                },
            ]
        });
        ...
        function openModal(id = '') {
            $.get('{{ route('admin.subscriptions.form') }}?id=' + id, function(data) {
